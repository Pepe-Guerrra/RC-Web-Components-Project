let fs,spin,color,logSymbols;_777‍.x([["createStructureProject",()=>createStructureProject]]);_777‍.w("fs",[["default",["fs"],function(v){fs=v}]]);_777‍.w("../supportFeature/spin.js",[["spin",["spin"],function(v){spin=v}],["color",["color"],function(v){color=v}],["logSymbols",["logSymbols"],function(v){logSymbols=v}]]);
