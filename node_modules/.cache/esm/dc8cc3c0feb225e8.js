let fs,spin,color,logSymbols;_feb‍.x([["createStructureProject",()=>createStructureProject]]);_feb‍.w("fs",[["default",["fs"],function(v){fs=v}]]);_feb‍.w("../supportFeature/spin.js",[["spin",["spin"],function(v){spin=v}],["color",["color"],function(v){color=v}],["logSymbols",["logSymbols"],function(v){logSymbols=v}]]);
