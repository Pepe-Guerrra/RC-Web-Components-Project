let fs,spin,color,logSymbols;_326‍.x([["createStructureProject",()=>createStructureProject]]);_326‍.w("fs",[["default",["fs"],function(v){fs=v}]]);_326‍.w("../supportFeature/spin.js",[["spin",["spin"],function(v){spin=v}],["color",["color"],function(v){color=v}],["logSymbols",["logSymbols"],function(v){logSymbols=v}]]);
