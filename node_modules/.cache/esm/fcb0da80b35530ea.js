let inquirer,fs,exec,createStructureProject,spin,color,logSymbols;_b35‍.x([["validationsProject",()=>validationsProject]]);_b35‍.w("inquirer",[["default",["inquirer"],function(v){inquirer=v}]]);_b35‍.w("fs",[["default",["fs"],function(v){fs=v}]]);_b35‍.w("child_process",[["exec",["exec"],function(v){exec=v}]]);_b35‍.w("../projectScripts/createStructure.js",[["createStructureProject",["createStructureProject"],function(v){createStructureProject=v}]]);_b35‍.w("../supportFeature/spin.js",[["spin",["spin"],function(v){spin=v}],["color",["color"],function(v){color=v}],["logSymbols",["logSymbols"],function(v){logSymbols=v}]]);
