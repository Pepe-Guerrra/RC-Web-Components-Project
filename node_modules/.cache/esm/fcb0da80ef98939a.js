let inquirer,fs,exec,createStructureProject,spin,color,logSymbols;_ef9‍.x([["validationsProject",()=>validationsProject]]);_ef9‍.w("inquirer",[["default",["inquirer"],function(v){inquirer=v}]]);_ef9‍.w("fs",[["default",["fs"],function(v){fs=v}]]);_ef9‍.w("child_process",[["exec",["exec"],function(v){exec=v}]]);_ef9‍.w("../projectScripts/createStructure.js",[["createStructureProject",["createStructureProject"],function(v){createStructureProject=v}]]);_ef9‍.w("../supportFeature/spin.js",[["spin",["spin"],function(v){spin=v}],["color",["color"],function(v){color=v}],["logSymbols",["logSymbols"],function(v){logSymbols=v}]]);
